...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date2.set(2015,4,15);
        Movie item1 = new Movie ("The Avengers","2012","pg13","Action | Sci-Fi","Nick Fury of S.H.I.E.L.D. assembles a team of superheroes to save the planet from Loki and his army.","Golden Village - Bishan",date1,4);
        Movie item2 = new Movie("Planes", "2013", "pg", "Animation | Comedy","A crop-dusting plane with a fear of heights lives his dream of competing in a famous around-the-world aerial race.","Cathay - AMK Hub",date2,2);
        movieList.add(item1);
        movieList.add(item2);

        caMovie = new CustomAdapter(this, R.layout.movies, movieList);
